...
const Schema: z.ZodType<Prisma.DiveUpdateManyWithWhereWithoutDiveCenterInput> =
  z
    .object({
...
export const DiveUpdateManyWithWhereWithoutDiveCenterInputObjectSchema = Schema;
