...
const Schema: z.ZodType<Prisma.LinkUncheckedUpdateManyWithoutDiveBuddyNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => LinkUpdateManyWithWhereWithoutDiveBuddyInputObjectSchema
          ),
          z
            .lazy(
              () => LinkUpdateManyWithWhereWithoutDiveBuddyInputObjectSchema
...
export const LinkUncheckedUpdateManyWithoutDiveBuddyNestedInputObjectSchema =
  Schema;
