...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithWhereWithoutEquipmentUnitInput> =
  z
    .object({
...
export const LinkUpdateManyWithWhereWithoutEquipmentUnitInputObjectSchema =
  Schema;
