...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithoutDiveSiteNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => LinkUpsertWithWhereUniqueWithoutDiveSiteInputObjectSchema),
        z
          .lazy(() => LinkUpsertWithWhereUniqueWithoutDiveSiteInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => LinkUpdateWithWhereUniqueWithoutDiveSiteInputObjectSchema),
        z
          .lazy(() => LinkUpdateWithWhereUniqueWithoutDiveSiteInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const LinkUpdateManyWithoutDiveSiteNestedInputObjectSchema = Schema;
