...
const Schema: z.ZodType<Prisma.NestedEnumWaterSurfaceNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumWaterSurfaceNullableWithAggregatesFilterObjectSchema =
  Schema;
