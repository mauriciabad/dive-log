...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithoutEquipmentUnitNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const LinkUpdateManyWithoutEquipmentUnitNestedInputObjectSchema = Schema;
