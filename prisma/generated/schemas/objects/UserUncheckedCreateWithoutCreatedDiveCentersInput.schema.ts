...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutCreatedDiveCentersInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutCreatedDiveCentersInputObjectSchema =
  Schema;
