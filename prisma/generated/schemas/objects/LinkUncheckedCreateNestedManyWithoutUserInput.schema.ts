...
const Schema: z.ZodType<Prisma.LinkUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const LinkUncheckedCreateNestedManyWithoutUserInputObjectSchema = Schema;
