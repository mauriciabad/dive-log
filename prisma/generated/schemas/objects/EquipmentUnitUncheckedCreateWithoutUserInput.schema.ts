...
const Schema: z.ZodType<Prisma.EquipmentUnitUncheckedCreateWithoutUserInput> = z
  .object({
...
export const EquipmentUnitUncheckedCreateWithoutUserInputObjectSchema = Schema;
