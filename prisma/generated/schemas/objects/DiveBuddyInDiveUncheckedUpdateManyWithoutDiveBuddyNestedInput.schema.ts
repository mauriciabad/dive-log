...
const Schema: z.ZodType<Prisma.DiveBuddyInDiveUncheckedUpdateManyWithoutDiveBuddyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyInDiveUncheckedUpdateManyWithoutDiveBuddyNestedInputObjectSchema =
  Schema;
