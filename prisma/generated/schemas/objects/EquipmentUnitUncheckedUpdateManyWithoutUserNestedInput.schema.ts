...
const Schema: z.ZodType<Prisma.EquipmentUnitUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EquipmentUnitUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
