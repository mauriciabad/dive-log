...
const Schema: z.ZodType<Prisma.DiveBuddyInDiveUncheckedCreateNestedManyWithoutDiveInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyInDiveUncheckedCreateNestedManyWithoutDiveInputObjectSchema =
  Schema;
