...
const Schema: z.ZodType<Prisma.NestedEnumUnitSystemNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumUnitSystemNullableWithAggregatesFilterObjectSchema =
  Schema;
