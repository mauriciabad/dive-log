...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithWhereWithoutDiveSiteInput> = z
  .object({
...
export const LinkUpdateManyWithWhereWithoutDiveSiteInputObjectSchema = Schema;
