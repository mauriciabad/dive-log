...
const Schema: z.ZodType<Prisma.DiveUpdateManyWithWhereWithoutDiveSiteInput> = z
  .object({
...
export const DiveUpdateManyWithWhereWithoutDiveSiteInputObjectSchema = Schema;
