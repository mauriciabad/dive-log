...
const Schema: z.ZodType<Prisma.DiveBuddyUpdateManyWithoutCreatorUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyUpdateManyWithoutCreatorUserNestedInputObjectSchema =
  Schema;
