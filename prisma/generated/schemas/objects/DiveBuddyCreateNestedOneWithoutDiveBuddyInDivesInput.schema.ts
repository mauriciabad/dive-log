...
const Schema: z.ZodType<Prisma.DiveBuddyCreateNestedOneWithoutDiveBuddyInDivesInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyCreateNestedOneWithoutDiveBuddyInDivesInputObjectSchema =
  Schema;
