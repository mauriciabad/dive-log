...
const Schema: z.ZodType<Prisma.DiveBuddyInDiveUncheckedUpdateManyWithoutDiveBuddyInDivesInput> =
  z
    .object({
      createdAt: z
        .union([
...
export const DiveBuddyInDiveUncheckedUpdateManyWithoutDiveBuddyInDivesInputObjectSchema =
  Schema;
