...
const Schema: z.ZodType<Prisma.EquipmentUnitUncheckedUpdateManyWithoutDivesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const EquipmentUnitUncheckedUpdateManyWithoutDivesNestedInputObjectSchema =
  Schema;
