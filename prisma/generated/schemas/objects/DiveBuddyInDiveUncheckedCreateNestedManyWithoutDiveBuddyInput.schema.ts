...
const Schema: z.ZodType<Prisma.DiveBuddyInDiveUncheckedCreateNestedManyWithoutDiveBuddyInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyInDiveUncheckedCreateNestedManyWithoutDiveBuddyInputObjectSchema =
  Schema;
