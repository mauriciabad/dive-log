...
const Schema: z.ZodType<Prisma.DiveBuddyUpdateWithoutDiveBuddyInDivesInput> = z
  .object({
    createdAt: z
      .union([
        z.date(),
...
export const DiveBuddyUpdateWithoutDiveBuddyInDivesInputObjectSchema = Schema;
