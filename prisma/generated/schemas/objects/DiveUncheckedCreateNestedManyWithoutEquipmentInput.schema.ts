...
const Schema: z.ZodType<Prisma.DiveUncheckedCreateNestedManyWithoutEquipmentInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveUncheckedCreateNestedManyWithoutEquipmentInputObjectSchema =
  Schema;
