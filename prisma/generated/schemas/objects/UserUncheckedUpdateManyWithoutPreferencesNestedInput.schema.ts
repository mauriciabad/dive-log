...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutPreferencesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutPreferencesNestedInputObjectSchema =
  Schema;
