...
const Schema: z.ZodType<Prisma.DiveUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveUncheckedUpdateManyWithoutUserNestedInputObjectSchema = Schema;
