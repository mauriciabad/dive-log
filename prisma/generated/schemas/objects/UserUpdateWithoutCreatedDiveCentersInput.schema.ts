...
import { DiveUpdateManyWithoutUserNestedInputObjectSchema } from "./DiveUpdateManyWithoutUserNestedInput.schema";
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutCreatedDiveCentersInput> = z
  .object({
    createdAt: z
      .union([
        z.date(),
    ...
    handle: z
      ...
      .optional(),
    dives: z
      .lazy(() => DiveUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    asDiveBuddy: z
      .lazy(
...
export const UserUpdateWithoutCreatedDiveCentersInputObjectSchema = Schema;
