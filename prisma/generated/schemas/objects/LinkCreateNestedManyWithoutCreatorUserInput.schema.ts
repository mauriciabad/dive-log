...
const Schema: z.ZodType<Prisma.LinkCreateNestedManyWithoutCreatorUserInput> = z
  .object({
    create: z
      .union([
...
export const LinkCreateNestedManyWithoutCreatorUserInputObjectSchema = Schema;
