...
const Schema: z.ZodType<Prisma.NestedEnumWaterEntryNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumWaterEntryNullableWithAggregatesFilterObjectSchema =
  Schema;
