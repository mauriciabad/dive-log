...
const Schema: z.ZodType<Prisma.DiveCenterUncheckedUpdateManyWithoutCreatedByUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveCenterUncheckedUpdateManyWithoutCreatedByUserNestedInputObjectSchema =
  Schema;
