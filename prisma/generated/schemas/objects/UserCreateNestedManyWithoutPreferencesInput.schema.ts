...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutPreferencesInput> = z
  .object({
    create: z
      .union([
...
export const UserCreateNestedManyWithoutPreferencesInputObjectSchema = Schema;
