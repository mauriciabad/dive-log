...
import { DiveSiteUpdateOneWithoutLinksNestedInputObjectSchema } from "./DiveSiteUpdateOneWithoutLinksNestedInput.schema";

import type { Prisma } from "@prisma/client";

const Schema: z.ZodType<Prisma.LinkUpdateWithoutEquipmentUnitInput> = z
  .object({
    createdAt: z
      .union([
        z.date(),
    ...
    user: z
      ...
      .optional(),
    diveSite: z
      .lazy(() => DiveSiteUpdateOneWithoutLinksNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const LinkUpdateWithoutEquipmentUnitInputObjectSchema = Schema;
