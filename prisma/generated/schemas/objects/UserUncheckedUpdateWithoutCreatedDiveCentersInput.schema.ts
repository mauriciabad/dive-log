...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCreatedDiveCentersInput> =
  z
    .object({
      createdAt: z
        .union([
...
export const UserUncheckedUpdateWithoutCreatedDiveCentersInputObjectSchema =
  Schema;
