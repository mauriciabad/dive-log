...
const Schema: z.ZodType<Prisma.LinkUncheckedCreateNestedManyWithoutEquipmentUnitInput> =
  z
    .object({
      create: z
        .union([
...
export const LinkUncheckedCreateNestedManyWithoutEquipmentUnitInputObjectSchema =
  Schema;
