...
const Schema: z.ZodType<Prisma.DiveUncheckedUpdateManyWithoutDiveSiteNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => DiveUpsertWithWhereUniqueWithoutDiveSiteInputObjectSchema
          ),
          z
            .lazy(
              () => DiveUpsertWithWhereUniqueWithoutDiveSiteInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => DiveUpdateWithWhereUniqueWithoutDiveSiteInputObjectSchema
          ),
          z
            .lazy(
              () => DiveUpdateWithWhereUniqueWithoutDiveSiteInputObjectSchema
...
export const DiveUncheckedUpdateManyWithoutDiveSiteNestedInputObjectSchema =
  Schema;
