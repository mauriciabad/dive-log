...
const Schema: z.ZodType<Prisma.DiveUncheckedUpdateManyWithoutEquipmentNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => DiveUpdateManyWithWhereWithoutEquipmentInputObjectSchema
          ),
          z
            .lazy(
              () => DiveUpdateManyWithWhereWithoutEquipmentInputObjectSchema
...
export const DiveUncheckedUpdateManyWithoutEquipmentNestedInputObjectSchema =
  Schema;
