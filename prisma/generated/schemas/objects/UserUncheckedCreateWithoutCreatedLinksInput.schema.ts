...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutCreatedLinksInput> = z
  .object({
...
export const UserUncheckedCreateWithoutCreatedLinksInputObjectSchema = Schema;
