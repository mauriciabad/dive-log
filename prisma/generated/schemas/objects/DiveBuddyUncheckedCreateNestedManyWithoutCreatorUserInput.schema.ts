...
const Schema: z.ZodType<Prisma.DiveBuddyUncheckedCreateNestedManyWithoutCreatorUserInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyUncheckedCreateNestedManyWithoutCreatorUserInputObjectSchema =
  Schema;
