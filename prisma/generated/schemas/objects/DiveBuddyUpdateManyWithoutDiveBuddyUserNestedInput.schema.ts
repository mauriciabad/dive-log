...
const Schema: z.ZodType<Prisma.DiveBuddyUpdateManyWithoutDiveBuddyUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyUpdateManyWithoutDiveBuddyUserNestedInputObjectSchema =
  Schema;
