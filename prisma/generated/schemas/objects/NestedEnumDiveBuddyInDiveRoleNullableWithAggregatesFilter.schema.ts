...
const Schema: z.ZodType<Prisma.NestedEnumDiveBuddyInDiveRoleNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumDiveBuddyInDiveRoleNullableWithAggregatesFilterObjectSchema =
  Schema;
