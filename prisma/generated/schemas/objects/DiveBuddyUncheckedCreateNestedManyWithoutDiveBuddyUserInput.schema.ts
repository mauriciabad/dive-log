...
const Schema: z.ZodType<Prisma.DiveBuddyUncheckedCreateNestedManyWithoutDiveBuddyUserInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveBuddyUncheckedCreateNestedManyWithoutDiveBuddyUserInputObjectSchema =
  Schema;
