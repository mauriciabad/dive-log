...
const Schema: z.ZodType<Prisma.EquipmentUnitUncheckedCreateNestedManyWithoutDivesInput> =
  z
    .object({
      create: z
        .union([
...
export const EquipmentUnitUncheckedCreateNestedManyWithoutDivesInputObjectSchema =
  Schema;
