...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithoutCreatorUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const LinkUpdateManyWithoutCreatorUserNestedInputObjectSchema = Schema;
