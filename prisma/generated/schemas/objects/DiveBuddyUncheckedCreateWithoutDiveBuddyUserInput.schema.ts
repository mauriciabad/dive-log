...
const Schema: z.ZodType<Prisma.DiveBuddyUncheckedCreateWithoutDiveBuddyUserInput> =
  z
    .object({
...
export const DiveBuddyUncheckedCreateWithoutDiveBuddyUserInputObjectSchema =
  Schema;
