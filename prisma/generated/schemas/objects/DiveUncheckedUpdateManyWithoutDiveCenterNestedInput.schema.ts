...
const Schema: z.ZodType<Prisma.DiveUncheckedUpdateManyWithoutDiveCenterNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => DiveUpdateManyWithWhereWithoutDiveCenterInputObjectSchema
          ),
          z
            .lazy(
              () => DiveUpdateManyWithWhereWithoutDiveCenterInputObjectSchema
...
export const DiveUncheckedUpdateManyWithoutDiveCenterNestedInputObjectSchema =
  Schema;
