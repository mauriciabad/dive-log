...
const Schema: z.ZodType<Prisma.EquipmentUnitUncheckedUpdateWithoutDivesInput> =
  z
    .object({
      createdAt: z
        .union([
...
export const EquipmentUnitUncheckedUpdateWithoutDivesInputObjectSchema = Schema;
