...
const Schema: z.ZodType<Prisma.DiveUpdateManyWithoutOrganismsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => DiveUpdateManyWithWhereWithoutOrganismsInputObjectSchema),
        z
          .lazy(() => DiveUpdateManyWithWhereWithoutOrganismsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const DiveUpdateManyWithoutOrganismsNestedInputObjectSchema = Schema;
