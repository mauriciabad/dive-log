...
const Schema: z.ZodType<Prisma.EquipmentUnitUncheckedUpdateWithoutLinksInput> =
  z
    .object({
      createdAt: z
        .union([
...
export const EquipmentUnitUncheckedUpdateWithoutLinksInputObjectSchema = Schema;
