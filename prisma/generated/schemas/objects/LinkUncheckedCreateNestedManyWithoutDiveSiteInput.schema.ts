...
const Schema: z.ZodType<Prisma.LinkUncheckedCreateNestedManyWithoutDiveSiteInput> =
  z
    .object({
      create: z
        .union([
...
export const LinkUncheckedCreateNestedManyWithoutDiveSiteInputObjectSchema =
  Schema;
