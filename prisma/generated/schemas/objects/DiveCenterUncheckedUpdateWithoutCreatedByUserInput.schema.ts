...
const Schema: z.ZodType<Prisma.DiveCenterUncheckedUpdateWithoutCreatedByUserInput> =
  z
    .object({
      createdAt: z
        .union([
...
export const DiveCenterUncheckedUpdateWithoutCreatedByUserInputObjectSchema =
  Schema;
