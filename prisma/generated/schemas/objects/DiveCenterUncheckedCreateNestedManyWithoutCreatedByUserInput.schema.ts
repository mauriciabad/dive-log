...
const Schema: z.ZodType<Prisma.DiveCenterUncheckedCreateNestedManyWithoutCreatedByUserInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveCenterUncheckedCreateNestedManyWithoutCreatedByUserInputObjectSchema =
  Schema;
