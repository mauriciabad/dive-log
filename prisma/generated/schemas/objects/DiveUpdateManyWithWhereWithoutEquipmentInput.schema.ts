...
const Schema: z.ZodType<Prisma.DiveUpdateManyWithWhereWithoutEquipmentInput> = z
  .object({
...
export const DiveUpdateManyWithWhereWithoutEquipmentInputObjectSchema = Schema;
