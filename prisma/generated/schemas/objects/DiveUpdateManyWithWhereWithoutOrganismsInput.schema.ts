...
const Schema: z.ZodType<Prisma.DiveUpdateManyWithWhereWithoutOrganismsInput> = z
  .object({
...
export const DiveUpdateManyWithWhereWithoutOrganismsInputObjectSchema = Schema;
