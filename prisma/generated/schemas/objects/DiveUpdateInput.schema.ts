...
import { UserUpdateOneRequiredWithoutDivesNestedInputObjectSchema } from "./UserUpdateOneRequiredWithoutDivesNestedInput.schema";
...
import { DiveSiteUpdateOneRequiredWithoutDivesNestedInputObjectSchema } from "./DiveSiteUpdateOneRequiredWithoutDivesNestedInput.schema";
...
import { EquipmentUnitUpdateManyWithoutDivesNestedInputObjectSchema } from "./EquipmentUnitUpdateManyWithoutDivesNestedInput.schema";
...
import { DiveCenterUpdateOneWithoutDivesNestedInputObjectSchema } from "./DiveCenterUpdateOneWithoutDivesNestedInput.schema";
import { DiveBuddyInDiveUpdateManyWithoutDiveNestedInputObjectSchema } from "./DiveBuddyInDiveUpdateManyWithoutDiveNestedInput.schema";
...
import { WikipediaPageUpdateManyWithoutDivesNestedInputObjectSchema } from "./WikipediaPageUpdateManyWithoutDivesNestedInput.schema";
import { LinkUpdateManyWithoutDiveNestedInputObjectSchema } from "./LinkUpdateManyWithoutDiveNestedInput.schema";
...
const Schema: z.ZodType<Prisma.DiveUpdateInput> = z
  .object({
    ...
    updatedAt: z
      ...
      .optional(),
    user: z
      .lazy(() => UserUpdateOneRequiredWithoutDivesNestedInputObjectSchema)
      .optional(),
    name: z
      .union([
        z.string(),
    ...
    specialtyDiveType: z
      ...
      .nullable(),
    diveSite: z
      .lazy(() => DiveSiteUpdateOneRequiredWithoutDivesNestedInputObjectSchema)
      .optional(),
    maximumDepth: z
      .union([
        z.number(),
    ...
    weight: z
      ...
      .nullable(),
    equipment: z
      .lazy(() => EquipmentUnitUpdateManyWithoutDivesNestedInputObjectSchema)
      .optional(),
    ...
    cylinderVolume: z
      ...
      .nullable(),
    diveCenter: z
      .lazy(() => DiveCenterUpdateOneWithoutDivesNestedInputObjectSchema)
      .optional(),
    diveBuddies: z
      .lazy(() => DiveBuddyInDiveUpdateManyWithoutDiveNestedInputObjectSchema)
      .optional(),
    roleasDiveBuddy: z
      .union([
      ...
      .nullable(),
    organisms: z
      .lazy(() => WikipediaPageUpdateManyWithoutDivesNestedInputObjectSchema)
      .optional(),
    rating: z
      .union([
        z.number(),
      ...
      .nullable(),
    links: z
      .lazy(() => LinkUpdateManyWithoutDiveNestedInputObjectSchema)
      .optional(),
    experienceNotes: z
      .union([
        z.string(),
