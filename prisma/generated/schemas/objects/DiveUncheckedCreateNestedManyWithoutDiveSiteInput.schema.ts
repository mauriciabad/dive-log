...
const Schema: z.ZodType<Prisma.DiveUncheckedCreateNestedManyWithoutDiveSiteInput> =
  z
    .object({
      create: z
        .union([
...
export const DiveUncheckedCreateNestedManyWithoutDiveSiteInputObjectSchema =
  Schema;
