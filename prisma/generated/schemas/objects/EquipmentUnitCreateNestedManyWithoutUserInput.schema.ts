...
const Schema: z.ZodType<Prisma.EquipmentUnitCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const EquipmentUnitCreateNestedManyWithoutUserInputObjectSchema = Schema;
