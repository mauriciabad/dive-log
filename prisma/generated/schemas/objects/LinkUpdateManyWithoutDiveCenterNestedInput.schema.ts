...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithoutDiveCenterNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => LinkUpdateManyWithWhereWithoutDiveCenterInputObjectSchema),
        z
          .lazy(() => LinkUpdateManyWithWhereWithoutDiveCenterInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const LinkUpdateManyWithoutDiveCenterNestedInputObjectSchema = Schema;
