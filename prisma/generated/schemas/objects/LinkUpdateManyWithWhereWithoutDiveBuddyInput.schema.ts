...
const Schema: z.ZodType<Prisma.LinkUpdateManyWithWhereWithoutDiveBuddyInput> = z
  .object({
...
export const LinkUpdateManyWithWhereWithoutDiveBuddyInputObjectSchema = Schema;
