...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCreatedLinksInput> = z
  .object({
    createdAt: z
      .union([
        z.date(),
...
export const UserUncheckedUpdateWithoutCreatedLinksInputObjectSchema = Schema;
