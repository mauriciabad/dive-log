...
const Schema: z.ZodType<Prisma.DiveBuddyInDiveUncheckedUpdateManyWithoutDiveBuddiesInput> =
  z
    .object({
      createdAt: z
        .union([
...
export const DiveBuddyInDiveUncheckedUpdateManyWithoutDiveBuddiesInputObjectSchema =
  Schema;
