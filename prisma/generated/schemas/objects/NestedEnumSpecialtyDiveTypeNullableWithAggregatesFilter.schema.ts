...
const Schema: z.ZodType<Prisma.NestedEnumSpecialtyDiveTypeNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumSpecialtyDiveTypeNullableWithAggregatesFilterObjectSchema =
  Schema;
