...
const Schema: z.ZodType<Prisma.LinkUncheckedUpdateWithoutEquipmentUnitInput> = z
  .object({
    createdAt: z
      .union([
        z.date(),
...
export const LinkUncheckedUpdateWithoutEquipmentUnitInputObjectSchema = Schema;
