...
export const CreateDiveSchema = z
  .object({
    ...
    duration: z
      ...
      .gte(1)
      .lte(24 * 60 * 60 * 1000),
    type: z.lazy(() => DiveTypeSchema).optional(),
    specialtyDiveType: z.lazy(() => SpecialtyDiveTypeSchema).optional(),
    ...
    waterBody: z.lazy(() => WaterBodySchema).optional(),
    waterType: z.lazy(() => WaterTypeSchema).optional(),
    waterEntry: z.lazy(() => WaterEntrySchema).optional(),
    waterCurrent: z.lazy(() => WaterCurrentSchema).optional(),
    waterSurface: z.lazy(() => WaterSurfaceSchema).optional(),
    waterVisibility: z.lazy(() => WaterVisibilitySchema).optional(),
    weather: z.lazy(() => WeatherSchema).optional(),
    ...
    cylinderMaterial: z.lazy(() => CylinderMaterialSchema).optional(),
    cylinderVolume: z.number().gt(0).optional(),
    diveCenter: z.any(), // Wrong
    diveBuddies: z.any(), // Wrong
    roleasDiveBuddy: z.lazy(() => DiveBuddyInDiveRoleSchema).optional(),
