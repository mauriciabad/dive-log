        ...
        <div>
          ...
          >
            ...
            <Item
              ...
              value={
                dive.specialtyDiveType !== null &&
                enumLabels.SpecialtyDiveType[dive.specialtyDiveType]
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Maximum depth"
              value={
                dive.maximumDepth !== null &&
                `${dive.maximumDepth.toFixed(1)} m`
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Average depth"
              value={
                dive.averageDepth !== null &&
                `${dive.averageDepth.toFixed(1)} m`
              }
              className="col-span-6"
            />
            <Item
          ...
          >
            <Item
              ...
              value={
                dive.waterMinimumTemperature !== null &&
                `${dive.waterMinimumTemperature.toFixed(0)} ºC`
              }
              className="col-span-6"
            />
            <Item
              ...
              value={
                dive.waterAverageTemperature !== null &&
                `${dive.waterAverageTemperature.toFixed(0)} ºC`
              }
              className="col-span-6"
            />
            <Item
              ...
              value={
                dive.waterMaximumTemperature !== null &&
                `${dive.waterMaximumTemperature.toFixed(0)} ºC`
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Water body"
              value={
                dive.waterBody !== null && enumLabels.WaterBody[dive.waterBody]
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Water type"
              value={
                dive.waterType !== null && enumLabels.WaterType[dive.waterType]
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Water entry"
              value={
                dive.waterEntry !== null &&
                enumLabels.WaterEntry[dive.waterEntry]
              }
              className="col-span-6"
            />
            <Item
              ...
              value={
                dive.waterVisibility !== null &&
                enumLabels.WaterVisibility[dive.waterVisibility]
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Water current"
              value={
                dive.waterCurrent !== null &&
                enumLabels.WaterCurrent[dive.waterCurrent]
              }
              className="col-span-6"
            />
            <Item
              ...
              title="Water surface"
              value={
                dive.waterSurface !== null &&
                enumLabels.WaterSurface[dive.waterSurface]
              }
              className="col-span-6"
            />
            <Item
            ...
            <Item
              ...
              value={
                dive.airTemperature !== null &&
                `${dive.airTemperature.toFixed(1)} ºC`
              }
              className="col-span-6"
            />
          </FormSection>
          ...
          >
            ...
            <Item
              ...
              value={
                dive.cylinderVolume !== null &&
                `${dive.cylinderVolume.toFixed(0)} l`
              }
              className="col-span-6"
            />
            <Item
              ...
              value={
                dive.startCylinderPresure !== null &&
                `${dive.startCylinderPresure.toFixed(0)} bar`
              }
              className="col-span-6"
            />
            <Item
              ...
              value={
                dive.endCylinderPresure !== null &&
                `${dive.endCylinderPresure.toFixed(0)} bar`
              }
              className="col-span-6"
            />
            <Item
              ...
              value={
                dive.cylinderMaterial !== null &&
                enumLabels.CylinderMaterial[dive.cylinderMaterial]
              }
              className="col-span-6"
            />
          </FormSection>
          ...
          >
            ...
            <Item
              ...
              value={
                dive.roleasDiveBuddy !== null &&
                enumLabels.DiveBuddyInDiveRole[dive.roleasDiveBuddy]
              }
              className="col-span-6"
            />
          </FormSection>
          ...
          {deleteDiveMutation.error && (
            <ErrorBox message={deleteDiveMutation.error?.message} />
          )}
        </div>
      ) : (
...
const Item: FC<{
  ...
  return (
    <div className={classNames(className, '')}>
      <Icon className="mr-1 inline-block h-4 w-4 text-sm" />
